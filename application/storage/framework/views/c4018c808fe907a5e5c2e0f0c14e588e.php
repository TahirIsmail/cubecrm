...
<!--warning-->
<div class="alert alert-warning"><?php echo app('translator')->get('lang.email_address_warning'); ?></div><?php /**PATH C:\laragon\www\cubecrm\application\resources\views/pages/webmail/compose/modal.blade.php ENDPATH**/ ?>