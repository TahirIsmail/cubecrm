    ...
    <!--resource type-->
    <input type="hidden" name="resource_type" value="<?php echo e($event['extendedProps']['resource_type'] ?? 'calendarevent'); ?>"><?php /**PATH C:\laragon\www\cubecrm\application\resources\views/pages/calendar/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>